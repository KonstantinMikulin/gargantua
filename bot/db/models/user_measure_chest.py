...
class MeasureChest(TimestampMixin, Base):
    __tablename__ = "measurements_chest"
    ...
    user: Mapped["User"] = relationship(back_populates="measurements_chest")  # type:ignore  # noqa: F821
